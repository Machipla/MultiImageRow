...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ImagePickerCoordinator/ImagePickerCoordinator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MultiImageRow/MultiImageRow.framework"
fi
